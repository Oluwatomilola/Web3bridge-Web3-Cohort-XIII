...
export interface TomiNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface TomiNFT extends BaseContract {
  connect(runner?: ContractRunner | null): TomiNFT;
  waitForDeployment(): Promise<this>;

  interface: TomiNFTInterface;
